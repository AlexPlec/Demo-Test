...
namespace Demo.Games
{
    public class GuessTheNumber
    {
        ...
        private static readonly GameDataManager _dataManager = new GameDataManager(new DemoContext());
        ...
        public static void StartPlayGuesTheNumber()
        {
        ...
        {
            var user = new GuessTheNumberUser
            {
                Attempts = attempts,
                Number = randomNumber
            };
        ...
        {
            await _dataManager.ShowDataAsync<GuessTheNumberUser>();
            infoMenu.ShowMenu();
        }

        public static async Task ShowDataStatisticAsync()
        {
            await _dataManager.ShowDataStatisticAsync<GuessTheNumberUser>();
            infoMenu.ShowMenu();
        }
    }
}